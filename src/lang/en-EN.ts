...
export const English: Language = {
  ...
  global: {
    ...
    willRestart: "CubeDB will restart in few seconds automatically.",
    generatedByCubeDB: "Generated by CubeDB",
  ...
  SETTINGS: {
    ...
    needsUpdate:
      "There is a new version of $1, but you need to have at least the version $2 of CubeDB. Please update CubeDB to the latest version.",
