...
export const Spanish: Language = {
  ...
  global: {
    ...
    refresh: "Refrescar",
    delete: "Eliminar",
    deleteWarning: '¿Está seguro que desea eliminar "$1"?',
    add: "Añadir",
    update: "Actualizar",
    save: "Guardar",
    clear: "Limpiar",
    ...
    routeMap: (r: string) => {
      const mp: [RegExp, string, string][] = [
        ...
        [
          /devices/i,
          "Dispositivos",
          "Agrega dispositivos para controlar partes específicas de la aplicación.",
        ],
      ];
  ...
  TIMER: {
    ...
    groupOfX: "En grupos de X tiempos",
    ...
    caseName(caseCode) {
      switch (caseCode) {
        case "edges-only":
          return "Solo aristas";
        case "corners-only":
          return "Solo esquinas";
        case "adjacent-corners":
          return "Esquinas adyacentes";
        case "diagonal-corners":
          return "Esquinas diagonales";
        case "double-cycles":
          return "Ciclos dobles";
        case "point":
          return "Punto";
        case "square":
          return "Cuadrado";
        ...
        case "different-colors":
          return "Colores diferentes";
        case "white-on-top":
          return "Blanca arriba";
        case "corner-in-place":
          return "Esquina en su lugar";
        case "edge-in-place":
          return "Arista en su lugar";
        case "unoriented":
          return "Mal orientadas";
      }
  ...
  PLL: {
    ...
    twoVariantBlock:
      "Para PLL's como <mark>Ja</mark> y <mark>Jb</mark>, la letra en minúscila es la variante <mark>a</mark> <mark>(j is Ja)</mark> y la letra en mayúsculas es la variante <mark>b</mark> <mark>(J is Jb)</mark>.",

    gPerms: "Permutación G",
    gPermsBlock:
      "Para las permutaciones G, puedes usar los números del <mark>1</mark> al <mark>4</mark> (Ga, Gb, Gc y Gd).",
  },
  SIMULATOR: {
    settings: "Configuración",
  ...
  TOOLS: {
    ...
    portraitWarning:
      "Rota el teléfono y activa el modo de pantalla completa para una mejor experiencia.",
    ...
    // Remote timer
    clickToAuth:
      "El servidor usa un certificado de red autofirmado, entonces usted debe aceptarlo manualmente en el navegador, haciendo click en el enlace siguiente.",
  },
  MENU: [
    [
      "WCA",
    ...
    ["Master Pyraminx", [["Aleatorio", "mpyr", 42]]],
    [
      "Pyraminx Crystal",
      [
        ["Pochmann", "prcp", 70],
    ...
    ["Square-2", [["Aleatorio", "sq2", 20]]],
    ["Super Floppy", [["Aleatorio", "sfl", 25]]],
    ["Super Square-1", [["Métrica de giro", "ssq1t", 20]]],
    ["UFO", [["Estilo Jaap", "ufo", 25]]],
    [
      "Bandaged",
      [
        ["Bicube", "bic", 30],
