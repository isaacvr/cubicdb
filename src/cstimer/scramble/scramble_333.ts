...
export function getLSLLScramble(type, length, cases) {
  var caze = f2l_map[ fixCase(cases, f2lprobs) ];
...
export function getZBLLScramble(type, length, cases) {
...
export function getCMLLScramble(type, length, cases) {
  var rnd4 = rn(4);
  var presuff = [];
...
export function getPLLScramble(type?, length?, cases?) {
...
export function getOLLScramble(type, length, cases) {
...
export function getEasyCrossScramble(type, length) {
  var cases = getEasyCross(length);
