...
<Router>
  ...
  <Route path="/tutorials" let:params> <Lazy component={ import('@components/Tutorials.svelte') } {params}/> </Route>
  <Route path="/tutorials/*" let:params> <Lazy component={ import('@components/TutorialParser.svelte') } {params}/> </Route>
