...
var CubeDB = (function () {
    ...
    /* node_modules\svelte-material-icons\Minus.svelte generated by Svelte v3.49.0 */

    const file = "node_modules\\svelte-material-icons\\Minus.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path, "d", "M19,13H5V11H19V13Z");
    ...
    /* node_modules\svelte-material-icons\Close.svelte generated by Svelte v3.49.0 */

    const file$1 = "node_modules\\svelte-material-icons\\Close.svelte";
    ...
    /* src\components\Frame.svelte generated by Svelte v3.49.0 */

    const { console: console_1 } = globals;
    const file$2 = "src\\components\\Frame.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "ml-1 w-8 flex my-auto");
    			add_location(img, file$2, 42, 2, 1002);
    			attr_dev(h4, "class", "ml-1");
    			add_location(h4, file$2, 44, 2, 1095);
    			add_location(span0, file$2, 47, 4, 1193);
    			attr_dev(span1, "class", "ml-2 cursor-pointer");
    			add_location(span1, file$2, 48, 4, 1218);
    			attr_dev(span2, "class", "ml-2 mr-1 cursor-pointer");
    			add_location(span2, file$2, 51, 4, 1310);
    			attr_dev(div, "class", "absolute right-0 top-0 flex h-8 items-center");
    			add_location(div, file$2, 46, 2, 1129);
    			attr_dev(section, "class", "w-full h-8 shadow-sm bg-gray-700 text-gray-400 fixed z-10 mb-3 select-none flex items-center");
    			add_location(section, file$2, 40, 0, 886);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(minus, span1, null);
    			append_dev(div, t5);
    			append_dev(div, span2);
    			mount_component(close_1, span2, null);
    			current = true;

    			if (!mounted) {
    				dispose = [
    					listen_dev(span1, "click", minimize, false, false, false),
    					listen_dev(span2, "click", maximize, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*date*/ 1) set_data_dev(t3, /*date*/ ctx[0]);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		$$invalidate(0, date = moment().format('hh:mm a'));
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Frame> was created with unknown prop '${key}'`);
    	});
    ...
    // (42:4) <Link class="mr-1 rounded-sm shadow-md uppercase p-2"      to="{part.link}">
    function create_default_slot(ctx) {
    	let t0_value = /*part*/ ctx[1].name + "";
    	let t0;
    	let t1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(42:4) <Link class=\\\"mr-1 rounded-sm shadow-md uppercase p-2\\\"      to=\\\"{part.link}\\\">",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	link = new Link({
    			props: {
    				class: "mr-1 rounded-sm shadow-md uppercase p-2",
    				to: /*part*/ ctx[1].link,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:2) {#each parts as part}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(nav, "class", "w-full px-5 inline-flex mt-10 select-none");
    			add_location(nav, file$4, 39, 0, 1120);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(t1_value);
    			t2 = space();
    			attr_dev(img, "class", "w-30 h-30 ");
    			if (!src_url_equal(img.src, img_src_value = /*card*/ ctx[1].cube)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", img_alt_value = /*card*/ ctx[1].title);
    			add_location(img, file$5, 22, 8, 463);
    			add_location(h2, file$5, 25, 8, 551);
    			attr_dev(li, "class", "w-40 h-48 text-center shadow-md rounded-md select-none cursor-pointer transition-all duration-200 hover:rotate-6 hover:shadow-lg ");
    			add_location(li, file$5, 17, 6, 281);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "w-full p-5");
    			add_location(ul, file$5, 15, 2, 220);
    			add_location(main, file$5, 14, 0, 210);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, currentPath, $$value => $$invalidate(1, $currentPath = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
